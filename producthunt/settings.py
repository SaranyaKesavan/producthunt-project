...
SECRET_KEY = 'ta++pi0&n&9nj-9r8x4ki%!h!gm*@ct&uc)e7sbr($st=%b9nd'
...
#media files (for user uploaded contents)
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
#where to access media files
MEDIA_URL = '/media/' #user defined can be anything u want